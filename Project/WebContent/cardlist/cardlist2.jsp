...
<div id="top2">
	<br><table width=600 border="1" cellpadding="0" cellspacing="0">
		...
		<tr align="center" valign="middle" bordercolor="#333333">
			...
			<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
				<div align="center">
					<button type="button" onclick="location.href=cardreview.bo?card_num=1">리 뷰</button>
				</div>
			</td>
		</tr>
		...
		<tr align="center" valign="middle" bordercolor="#333333">
			...
			<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
				<div align="center">
					<button type="button" onclick="location.href=cardreview.bo?card_num=2">리 뷰</button>
				</div>
			</td>
		</tr>
		...
		<tr align="center" valign="middle" bordercolor="#333333">
			...
			<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
				<div align="center">
					<button type="button" onclick="location.href=cardreview.bo?card_num=3">리 뷰</button>
				</div>
			</td>
		</tr>
		...
		<tr align="center" valign="middle" bordercolor="#333333">
			...
			<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
				<div align="center">
					<button type="button" onclick="location.href=cardreview.bo?card_num=4">리 뷰</button>
				</div>
			</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=5">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=6">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=7">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=8">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=9">리 뷰</button>
			</div>
		</td>
		</tr>
		<td style="font-family: Tahoma; font-size: 8pt;" width="8%" height="26">
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=10">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=11">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=12">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=13">리 뷰</button>
			</div>
		</td>
		</tr>
		...
		<td style="font-family: Tahoma; font-size: 8pt;" width="10%">
			<div align="center">
				<button type="button" onclick="location.href=cardreview.bo?card_num=14">리 뷰</button>
		</td>
		</tr>
		<tr align="right">
